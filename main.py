...
def main():
    ...
    uploaded_files = st.file_uploader("Hola Nico! elige un archivo CSV", accept_multiple_files=True, on_change=main, help="Selecciona uno o más archivos CSV para graficar")
